...
void
Anemos::MakeNewLevelFromCoarse (int lev, Real time, const BoxArray& ba,
...
// overrides the pure virtual function in AmrCore
void
Anemos::RemakeLevel (int lev, Real time, const BoxArray& ba,
			 const DistributionMapping& dm)
{
...
// overrides the pure virtual function in AmrCore
void Anemos::MakeNewLevelFromScratch (int lev, Real time, const BoxArray& ba,
					  const DistributionMapping& dm)
{
    const int ncomp = 1;
    const int nghost = 0;
...
// overrides the pure virtual function in AmrCore
void
Anemos::ErrorEst (int lev, TagBoxArray& tags, Real time, int ngrow)
{
...
void
Anemos::AverageDownTo (int crse_lev)
{
...
void
Anemos::FillPatch (int lev, Real time, MultiFab& mf, int icomp, int ncomp)
{
    if (lev == 0)
    {
	Vector<MultiFab*> smf;
...
void
Anemos::FillCoarsePatch (int lev, Real time, MultiFab& mf, int icomp, int ncomp)
{
    BL_ASSERT(lev > 0);
...
void
Anemos::GetData (int lev, Real time, Vector<MultiFab*>& data, Vector<Real>& datatime)
{
    data.clear();
    datatime.clear();
...
void
Anemos::timeStepWithSubcycling (int lev, Real time, int iteration)
{
...
void
Anemos::timeStepNoSubcycling (Real time, int iteration)
{
...
Real
Anemos::EstTimeStep (int lev, Real time, bool local)
{
    BL_PROFILE("Anemos::EstTimeStep()");
...
// get plotfile name
std::string
Anemos::PlotFileName (int lev) const
{
...
void
Anemos::WriteCheckpointFile () const
{
   ...
   if (ParallelDescriptor::IOProcessor()) {
       ...
       HeaderFile << "Checkpoint file for Anemos\n";
...
void
Anemos::GotoNextLine (std::istream& is)
{
